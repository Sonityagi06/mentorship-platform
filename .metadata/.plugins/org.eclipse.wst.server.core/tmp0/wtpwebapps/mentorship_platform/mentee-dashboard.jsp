...
<body>
    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <img src="images/mentee1.png" alt="Profile" class="profile-img">
                <h3><%= user.getName() %></h3>
    ...
    <div class="card">
        <img src="https://img.icons8.com/ios-filled/50/000000/comments.png" alt="Messages" class="card-icon">
                    <h3>Your Messages</h3>
                    <p>Communicate with your mentors and stay updated.</p>
                <a href="mentee-messages.jsp" class="btn">View Messages</a>
