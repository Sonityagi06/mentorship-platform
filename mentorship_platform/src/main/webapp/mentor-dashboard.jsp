    ...
    <div class="dashboard-container">
        ...
        <div class="sidebar">
            <div class="sidebar-header">
                <img src="images/mentorr.jpeg" alt="Profile" class="profile-img">
                <h3><%= user.getName() %></h3>
                <p><%= user.getRole().substring(0,1).toUpperCase() + user.getRole().substring(1) %></p>
            </div>
            <ul class="menu">
                <li><a href="mentor-dashboard.jsp">Dashboard</a></li>
                <li><a href="mentor-appointments.jsp">Appointments</a></li>
                <li><a href="mentor-messages.jsp">Messages</a></li>
                <li><a href="edit-mentor-profile.jsp">Profile</a></li>
        ...
        <div class="main-content">
            ...
            <div class="cards-container">
                ...
                <div class="card">
                    ...
                    <a href="mentor-messages.jsp" class="btn">View Messages</a>
                </div>
                <div class="card">
